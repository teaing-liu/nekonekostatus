...
REPO_API="https://api.github.com/repos/teaing-liu/nekonekostatus/releases/latest"
VERSION=$(curl -s "$REPO_API" | grep '"tag_name"' | sed 's/.*: "\(.*\)".*/\1/')

# 修改点2: 使用版本号构建正确的下载链接
PRIMARY_URL="https://github.com/teaing-liu/nekonekostatus/releases/download/${VERSION}"
BACKUP_URL="https://ghproxy.com/https://github.com/teaing-liu/nekonekostatus/releases/download/${VERSION}"
